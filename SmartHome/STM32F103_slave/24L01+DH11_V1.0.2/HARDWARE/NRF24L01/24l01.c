...
const u8 RX_ADDRESS[TX_ADR_WIDTH]={0x12,0x23,0x34,0x45,0x56}; //发送地址
const u8 TX_ADDRESS[RX_ADR_WIDTH]={0x56,0x45,0x34,0x23,0x12}; //发送地址
...
{ 	
	...
	GPIO_ResetBits(GPIOB,GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8);//PG6,7,8上拉					 
