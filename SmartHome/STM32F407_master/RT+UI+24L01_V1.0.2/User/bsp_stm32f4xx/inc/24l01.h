...
#define NRF24L01_IRQ  PAin(7)  //IRQ主机数据输入
//24L01发送接收数据宽度定义
...
void NRF24L01_RX_Mode(u8 *address);//配置为接收模式
void NRF24L01_TX_Mode(u8 *address);//配置为发送模式
u8 NRF24L01_Write_Buf(u8 reg, u8 *pBuf, u8 u8s);//写数据区
u8 NRF24L01_Read_Buf(u8 reg, u8 *pBuf, u8 u8s);//读数据区		  
u8 NRF24L01_Read_Reg(u8 reg);			//读寄存器
u8 NRF24L01_Write_Reg(u8 reg, u8 value);//写寄存器
u8 NRF24L01_Check(void);//检查24L01是否存在
u8 NRF24L01_TxPacket(u8 *rxbuf ,u8 *address);//发送一个包的数据
u8 NRF24L01_RxPacket(u8 *rxbuf ,u8 *address);//接收一个包的数据
