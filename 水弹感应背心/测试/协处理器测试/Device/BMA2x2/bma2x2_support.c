...
*---------------------------------------------------------------------------*/
	...
	bw_value_u8 = 0x10;/* set bandwidth of 7.81Hz*/
	com_rslt += bma2x2_set_bw(BMA2x2_BW_1000HZ);
...
s8 BMA2x2_I2C_bus_write(u8 dev_addr, u8 reg_addr, u8 *reg_data, u8 cnt)
{
	...
	iError = I2C_WRITE_STRING(dev_addr,reg_data,cnt+1);
...
s8 BMA2x2_I2C_bus_read(u8 dev_addr, u8 reg_addr, u8 *reg_data, u8 cnt)
{
	...
	iError = I2C_WRITE_READ_STRING(dev_addr,array,array,cnt);
...
s8 BMA2x2_SPI_bus_read(u8 dev_addr, u8 reg_addr, u8 *reg_data, u8 cnt)
{
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET);
		HAL_SPI_Transmit(&hspi1, &array[BMA2x2_INIT_VALUE], 1, 1000); 
		
		HAL_SPI_Receive(&hspi1,array, cnt, 1000);
...
s8 BMA2x2_SPI_bus_write(u8 dev_addr, u8 reg_addr, u8 *reg_data, u8 cnt)
{
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET);
		HAL_SPI_Transmit(&hspi1, array, cnt*2, 1000); 
		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET);
