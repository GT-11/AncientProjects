...
SD_Error SD_WaitWriteOperation (void)
{
	...
	while ((DMAEndOfTransfer == 0x00) && (TransferEnd == 0) && (TransferError == SD_OK) && (timeout > 0)) // && (timeout > 0)
	{   
		timeout--;
	}
...
//	TM_GPIO_SetPullResistor(GPIOC, GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12, TM_GPIO_PuPd_DOWN);
	TM_GPIO_DeInit(GPIOA, GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_6);
	TM_GPIO_SetPullResistor(GPIOA, GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_6, TM_GPIO_PuPd_DOWN);
	
	TM_GPIO_DeInit(GPIOB, GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_15);
	TM_GPIO_SetPullResistor(GPIOB, GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_15, TM_GPIO_PuPd_DOWN);
#else
...
#if FATFS_SDIO_4BIT == 1
	TM_GPIO_InitAlternate(GPIOA, GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_6, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_Fast, GPIO_AF_SDIO);
	TM_GPIO_InitAlternate(GPIOB, GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_15, TM_GPIO_OType_PP, TM_GPIO_PuPd_UP, TM_GPIO_Speed_Fast, GPIO_AF_SDIO);
