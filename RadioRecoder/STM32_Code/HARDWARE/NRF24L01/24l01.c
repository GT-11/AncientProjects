...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x34,0x43,0x12,0x13,0x14}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x14,0x13,0x12,0x43,0x34}; //发送地址
...
{  
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOB, ENABLE);//使能GPIOB,G时钟
