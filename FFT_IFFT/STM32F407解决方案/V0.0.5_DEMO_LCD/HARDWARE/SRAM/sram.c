...
{	
  ...
  writeTiming.FSMC_DataSetupTime = 80;		 //数据保存时间为6ns*9个HCLK=54ns
...
void FSMCDMA_Config(DMA_Stream_TypeDef *DMA_Streamx,u32 chx,u32 par,u32 mar,u16 ndtr)
{ 
...
//ndtr:数据传输量  
void FSMCDMA_Enable(DMA_Stream_TypeDef *DMA_Streamx,u16 ndtr)
{
