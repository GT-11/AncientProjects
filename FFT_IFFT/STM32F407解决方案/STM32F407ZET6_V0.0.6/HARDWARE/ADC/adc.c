...
//			 TIM_OCInitTypeDef  TIM_OCInitStructure;
        ...
        TIM_TimeBaseStructure.TIM_Period=9999; /* 经过9999+1溢出 */
        
        TIM_TimeBaseStructure.TIM_Prescaler=8399; /* 分频8399+1 */
        
        TIM_TimeBaseStructure.TIM_RepetitionCounter=0; /* 重复计数器 0 */
